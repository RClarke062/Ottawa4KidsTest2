package com.robboapps.ottawa4kidstest2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lstView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                switch (itemValue) {
                    case "WebSite":
                        Intent i = new Intent("com.robboapps.ottawa4kidstest2.WebSiteActivity");
                        //---use putExtra() to send the ThirdActivity choice to the WebSite Activity---
                        i.putExtra("str1", getIntent().getStringExtra("str1"));
                        startActivity(i);
                        break;
                    case "Where is It":
                        Intent a = new Intent("com.robboapps.ottawa4kidstest2.WhereActivity");
                    ...
                    case "Side Trips for Adults":
                        Intent b = new Intent("com.robboapps.ottawa4kidstest2.SideTripsActivity");
                        //---use putExtra() to send the ThirdActivity choice to the SideTrips Activity---
                        b.putExtra("str1", getIntent().getStringExtra("str1"));
                        startActivity(b);
                        break;
                    case "Whats Cool":
                        Intent c = new Intent("com.robboapps.ottawa4kidstest2.WhatsCoolActivity");
